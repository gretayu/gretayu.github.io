    ...
    d.fn.fullpage = function(c) {
        ...
        function L(a, b) {
            if (l.m[a]) {
                ...
                if (0 < b.length)
                    if (c.scrollOverflowHandler.isScrolled(d, b))
                        f();
                    else
                        return !0;
                else
            ...
            requestAnimFrame(function() {
                ...
                if ("undefined" !== typeof f) {
                    ...
                    if (!(f.activeSection.is(a) && !t || c.scrollBar && p.scrollTop() === f.dtop && !a.hasClass("fp-auto-height"))) {
                        ...
                        f.leavingSection, f.sectionIndex + 1, f.yMovement))
                            za(f.activeSection), a.addClass("active").siblings().removeClass("active"), K(a), w = !1, aa(k, h, f.anchorLink, f.sectionIndex), Wa(f), z = f.anchorLink, W(f.anchorLink, f.sectionIndex)
                    }
                }
            })
        }
        function Wa(a) {
            if (c.css3 && c.autoScrolling && !c.scrollBar)
                Aa("translate3d(0px, -" + a.dtop + "px, 0px)", !0), c.scrollingSpeed ? ea = setTimeout(function() {
                    fa(a)
        ...
        function Ea() {
            ...
            if (Q) {
                ...
                clearTimeout(la), la = setTimeout(function() {
                    e.reBuild(!0)
                }, 350)
        }
        function na() {
        ...
        function Fa(a) {
            ...
            if (c.paddingTop || c.paddingBottom)
                b = a, b.hasClass("fp-section") || (b = a.closest(".fp-section")), a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom")), b = r - a;
            return b
        }
        function Aa(a, b) {
        ...
        function Na() {
            ...
            for (var d in c)
                a.style[d] !== E && (a.style[d] = "translate3d(1px,1px,1px)", b = h.getComputedStyle(a).getPropertyValue(c[d]));
        ...
        e.setMouseWheelScrolling = function(a) {
            if (a) {
                ...
                if ("DOMMouseScroll" == c)
                    m[b](a + "MozMousePixelScroll", B, !1);
                else
                    m[b](a + c, B, !1)
            } else
                m.addEventListener ? (m.removeEventListener("mousewheel", B, !1), m.removeEventListener("wheel", B, !1), m.removeEventListener("MozMousePixelScroll", B, !1)) : m.detachEvent("onmousewheel", B)
        };
    ...
    ma = {
        ...
        isScrolled: function(c, d) {
            if ("top" === c)
                return !d.scrollTop();
            if ("bottom" === c)
                return d.scrollTop() + 1 + d.innerHeight() >= d[0].scrollHeight
        },
